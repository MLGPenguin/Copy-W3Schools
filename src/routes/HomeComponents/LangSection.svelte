<script lang="ts">
    import type { TextBox } from "./HomeTypes";
    import type { Pill } from "./HomeTypes"

    import TextBoxComponent from "$lib/components/TextBoxComponent.svelte";
...
<div class="h-12" />
  <div id="container" class="flex w-[80%] font-semibold">
    ...
    <div id="left" class="w-[50%] items-center flex flex-col">
      <h1 class="text-8xl my-4">{name}</h1>
